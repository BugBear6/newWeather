    ...
    .factory('getFlickrPhotoService', function ($http) {
        return {
            getCity: function (city) {
                ...
                var url = `https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=${flickr_key}&text=${cityName}&per_page=100&format=json&sort=relevance&nojsoncallback=1`;
                return $http({
                    method: 'GET',
                    url: url
                });
